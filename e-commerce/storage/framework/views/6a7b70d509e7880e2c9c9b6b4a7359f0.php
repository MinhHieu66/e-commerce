...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/font-awesome.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/flaticon/flaticon.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/slick.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/slick-theme.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/jquery-ui.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/sal.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/magnific-popup.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/vendor/base.css')); ?>">
                ...
                <div class="header-navbar">
                    <div class="header-brand">
                        <a href="index.html" class="logo logo-dark">
                            <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Site Logo">
                        </a>
                        <a href="index.html" class="logo logo-light">
                            <img src="<?php echo e(asset('images/logo/logo-light.png')); ?>" alt="Site Logo">
                        </a>
                    </div>
                            ...
                            <ul class="mainmenu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="axil-submenu">
                                        ...
                                        <li><a href="<?php echo e(route('shop')); ?>">Shop no Sidebar</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="axil-footer-widget">
                            ...
                            <a href="index.html">
                                <img class="light-logo" src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Logo Images">
                            </a>
                        </div> -->
                            <div class="inner">
                        ...
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                ...
                                <div class="download-btn-group">
                                    <div class="qr-code">
                                        <img src="<?php echo e(asset('images/others/qr.png')); ?>" alt="Axilthemes">
                                    </div>
                                    <div class="app-link">
                                        <a href="#">
                                            <img src="<?php echo e(asset('images/others/app-store.png')); ?>" alt="App Store">
                                        </a>
                                        <a href="#">
                                            <img src="<?php echo e(asset('images/others/play-store.png')); ?>" alt="Play Store">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="copyright-right d-flex flex-wrap justify-content-xl-end justify-content-center align-items-center">
                            ...
                            <ul class="payment-icons-bottom quick-link">
                                <li><img src="<?php echo e(asset('images/icons/cart/cart-1.png')); ?>" alt="paypal cart"></li>
                                <li><img src="<?php echo e(asset('images/icons/cart/cart-2.png')); ?>" alt="paypal cart"></li>
                                <li><img src="<?php echo e(asset('images/icons/cart/cart-5.png')); ?>" alt="paypal cart"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-10 order-lg-2">
                                        <div class="single-product-thumbnail product-large-thumbnail axil-product thumbnail-badge zoom-gallery">
                                            <div class="thumbnail">
                                                <img src="<?php echo e(asset('images/product/product-big-01.png')); ?>" alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                                <div class="product-quick-view position-view">
                                                    <a href="<?php echo e(asset('images/product/product-big-01.png')); ?>" class="popup-zoom">
                                                        <i class="far fa-search-plus"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="thumbnail">
                                                <img src="<?php echo e(asset('images/product/product-big-02.png')); ?>" alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                                <div class="product-quick-view position-view">
                                                    <a href="<?php echo e(asset('images/product/product-big-02.png')); ?>" class="popup-zoom">
                                                        <i class="far fa-search-plus"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="thumbnail">
                                                <img src="<?php echo e(asset('images/product/product-big-03.png')); ?>" alt="Product Images">
                                                <div class="label-block label-right">
                                                    <div class="product-badget">20% OFF</div>
                                                </div>
                                                <div class="product-quick-view position-view">
                                                    <a href="<?php echo e(asset('images/product/product-big-03.png')); ?>" class="popup-zoom">
                                                        <i class="far fa-search-plus"></i>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-2 order-lg-1">
                                        <div class="product-small-thumb small-thumb-wrapper">
                                            <div class="small-thumb-img">
                                                <img src="<?php echo e(asset('images/product/product-thumb/thumb-08.png')); ?>" alt="thumb image">
                                            </div>
                                            <div class="small-thumb-img">
                                                <img src="<?php echo e(asset('images/product/product-thumb/thumb-07.png')); ?>" alt="thumb image">
                                            </div>
                                            <div class="small-thumb-img">
                                                <img src="<?php echo e(asset('images/product/product-thumb/thumb-09.png')); ?>" alt="thumb image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="inner">
                                        <div class="product-rating">
                                            <div class="star-rating">
                                                <img src="<?php echo e(asset('images/icons/rate.png')); ?>" alt="Rate Images">
                                            </div>
                    ...
                    <div class="axil-product-list">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img src="<?php echo e(asset('images/product/electric/product-09.png')); ?>" alt="Yantiti Leather Bags">
                            </a>
                        </div>
        ...
        <div class="cart-content-wrap">
            ...
            <div class="cart-body">
                <ul class="cart-item-list">
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product.html"><img src="<?php echo e(asset('images/product/electric/product-01.png')); ?>" alt="Commodo Blown Lamp"></a>
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product-2.html"><img src="<?php echo e(asset('images/product/electric/product-02.png')); ?>" alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
                            <div class="product-rating">
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product-3.html"><img src="<?php echo e(asset('images/product/electric/product-03.png')); ?>" alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
                            <div class="product-rating">
...
============================================ -->
    ...
    <script src="<?php echo e(asset('js/vendor/js.cookie.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('js/vendor/jquery.style.switcher.js')); ?>"></script> -->
    <script src="<?php echo e(asset('js/vendor/jquery-ui.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/jquery.ui.touch-punch.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/jquery.countdown.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/sal.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/jquery.magnific-popup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/imagesloaded.pkgd.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/isotope.pkgd.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/counterup.js')); ?>"></script>
...
<?php /**PATH D:\e-commerce\e-commerce\resources\views/template/user.blade.php ENDPATH**/ ?>