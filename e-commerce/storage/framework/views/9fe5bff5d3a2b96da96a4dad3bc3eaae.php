...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('')); ?>assets/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('')); ?>assets/images/dashboard/favicon.png" type="image/x-icon">
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="blur-up lazyloaded d-block d-lg-none"
                                src="<?php echo e(asset('')); ?>assets/images/dashboard/multikart-logo-black.png" alt="">
                        </a>
                    </div>
                </div>
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center">
                                <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                                    src="<?php echo e(asset('')); ?>assets/images/dashboard/user3.jpg" alt="header-user">
            ...
            <div class="page-sidebar">
                    ...
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="d-none d-lg-block blur-up lazyloaded"
                                src="<?php echo e(asset('')); ?>assets/images/dashboard/multikart-logo.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="sidebar-header" href="<?php echo e(route("admin.coupon")); ?>">
                                ...
                                <ul class="list">
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="<?php echo e(asset('')); ?>assets/images/dashboard/user.jpg" alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="<?php echo e(asset('')); ?>assets/images/dashboard/user1.jpg" alt="">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="<?php echo e(asset('')); ?>assets/images/dashboard/user2.jpg" alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="<?php echo e(asset('')); ?>assets/images/dashboard/user3.jpg" alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="<?php echo e(asset('')); ?>assets/images/dashboard/user5.jpg" alt="">
                                        <div class="status-circle away"></div>
                                        <div class="about">
                                    ...
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="<?php echo e(asset('')); ?>assets/images/dashboard/designer.jpg" alt="">
                                        <div class="status-circle online"></div>
                                        <div class="about">
...
</html><?php /**PATH D:\e-commerce\e-commerce\resources\views/template/admin.blade.php ENDPATH**/ ?>