...
<head>
	...
	<link href="<?php echo e(asset('')); ?>assets/css/materialdesignicons.min.css " rel="stylesheet" />
	<!-- PLUGINS CSS STYLE -->
...
<link href="<?php echo e(asset('assets/css/responsive.datatables.min.css')); ?>" rel="stylesheet">

	<!-- custom css -->
	<link id="style.css" rel="stylesheet" href="<?php echo e(asset('')); ?>') }}assets/css/style.css">
	...
	<div class="wrapper">
		...
		<div class="ec-left-sidebar ec-bg-sidebar">
			<div id="sidebar" class="sidebar ec-sidebar-footer">
				...
				<div class="ec-brand">
					<a href="index.html">
						<img class="ec-brand-icon" src="<?php echo e(asset('')); ?>') }}assets/images/dashboard/multikart-logo-black.png" alt="" />
			...
			<header class="ec-main-header" id="header">
				<nav class="navbar navbar-static-top navbar-expand-lg">
					...
					<button id="sidebar-toggler">
						<img src="<?php echo e(asset('')); ?>assets/img/icons/clops.png " alt="">
					</button>
					<!-- search form -->
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user-menu">
								<button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
									aria-expanded="false">
									<img src="<?php echo e(asset('')); ?>assets/img/user/user-1.png " class="user-image"
										alt="User Image" />
								</button>
											...
											<ul class="list-unstyled" data-simplebar style="height: 360px">
													...
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="<?php echo e(asset('')); ?>assets/img/user/u2.jpg') }} "
																alt="Image">
												...
												<li>
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="<?php echo e(asset('')); ?>assets/img/user/u1.jpg') }} "
																alt="Image">
												...
												<li>
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="<?php echo e(asset('')); ?>assets/img/user/u5.jpg') }} "
																alt="Image">
															<span class="status away"></span>
														</div>
														<div class="media-body d-flex justify-content-between">
												...
												<li>
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="<?php echo e(asset('')); ?>assets/img/user/u4.jpg') }} "
																alt="Image">
															<span class="status away"></span>
														</div>
														<div class="media-body d-flex justify-content-between">
															...
															<form method="POST"
																...
																<div class="modal-header">
																	<h5 class="modal-title"
																		id="editUserModalLabel<?php echo e($user->id); ?>">Chỉnh Sửa
																		Người Dùng</h5>
																	<button type="button" class="btn-close"
																		data-bs-dismiss="modal" aria-label="Close"></button>
																</div>
																<div class="modal-body">
																	...
																	<div class="mb-3">
																		<label for="email_address<?php echo e($user->id); ?>"
																			class="form-label">Email</label>
																		<input type="email" class="form-control"
																			id="email_address<?php echo e($user->id); ?>"
																			name="email_address"
																			value="<?php echo e($user->email_address); ?>" required>
																	</div>
																	<div class="mb-3">
																		<label for="password<?php echo e($user->id); ?>"
																			...
																			muốn thay đổi)</label>
																		<input type="password" class="form-control"
																			id="password<?php echo e($user->id); ?>" name="password">
																	</div>
																</div>
																<div class="modal-footer">
																	<button type="button" class="btn btn-secondary"
															...
															<div class="btn-group">
																...
																<div class="dropdown-menu">
																	<button class="dropdown-item" data-bs-toggle="modal"
																		data-bs-target="#editUserModal<?php echo e($user->id); ?>">Edit</button>
...
</html><?php /**PATH D:\e-commerce\e-commerce\resources\views/user/user-list.blade.php ENDPATH**/ ?>