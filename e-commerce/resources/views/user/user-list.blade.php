			...
			<header class="ec-main-header" id="header">
				<nav class="navbar navbar-static-top navbar-expand-lg">
					...
					<button id="sidebar-toggler">
						<img src="{{ asset('') }}assets/img/icons/clops.png " alt="">
					</button>
					<!-- search form -->
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user-menu">
								<button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
									aria-expanded="false">
									<img src="{{ asset('') }}assets/img/user/user-1.png " class="user-image"
										alt="User Image" />
								</button>
											...
											<ul class="list-unstyled" data-simplebar style="height: 360px">
													...
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="{{ asset('') }}assets/img/user/u2.jpg') }} "
																alt="Image">
												...
												<li>
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="{{ asset('') }}assets/img/user/u1.jpg') }} "
																alt="Image">
												...
												<li>
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="{{ asset('') }}assets/img/user/u5.jpg') }} "
																alt="Image">
															<span class="status away"></span>
														</div>
														<div class="media-body d-flex justify-content-between">
												...
												<li>
													<a href="javscript:void(0)"
														...
														<div class="position-relative mr-3">
															<img class="rounded-circle"
																src="{{ asset('') }}assets/img/user/u4.jpg') }} "
																alt="Image">
															<span class="status away"></span>
														</div>
														<div class="media-body d-flex justify-content-between">
										...
										<table id="responsive-data-table" class="table">
															...
															<form method="POST"
																...
																<div class="modal-header">
																	<h5 class="modal-title"
																		id="editUserModalLabel{{ $user->id }}">Chỉnh Sửa
																		Người Dùng</h5>
																	<button type="button" class="btn-close"
																		data-bs-dismiss="modal" aria-label="Close"></button>
																</div>
											...
											<tbody>
												...
												<tr>
													<td>#003</td>
													<td><img class="cat-thumb"
															src="{{ asset('') }}assets/img/user/u3.jpg "
															alt="Product Image" /></td>
													<td>Esther Howard</td>
												...
												<tr>
													<td>#006 </td>
													<td><img class="cat-thumb"
															src="{{ asset('') }}assets/img/user/u6.jpg "
															alt="Product Image" /></td>
													<td>Esther Howard</td>
													<td>michale@example.com</td>
													<td>1794</td>
												...
												<tr>
													<td>#007 </td>
													<td><img class="cat-thumb"
															src="{{ asset('') }}assets/img/user/u7.jpg "
															alt="Product Image" /></td>
													<td>Esther Howard</td>
													<td>michale@example.com</td>
													<td>1794</td>
												...
												<tr>
													<td>#008 </td>
													<td><img class="cat-thumb"
															src="{{ asset('') }}assets/img/user/u8.jpg "
															alt="Product Image" /></td>
													<td>Esther Howard</td>
													<td>michale@example.com</td>
													<td>1794</td>
