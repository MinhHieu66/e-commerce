...
class PaymentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->vnp_TmnCode    = "97PYDBPE";                         //Mã định danh merchant kết nối (Terminal Id)
        $this->vnp_HashSecret = "0OUZ222173U4MK8MJNN7VCAPIC6OZ1XA"; //Secret key
        ...
        $this->vnp_Returnurl = "https://www.google.com/";
    ...
    public function payWithMomo(Request $request)
    {
        ...
        $amount      = $request->input('amount', 1000000);
        $orderId     = time() . "";
