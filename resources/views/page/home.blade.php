                                ...
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="400"
                                    ...
                                    <div class="slide-action">
                                        ...
                                        <div class="item-rating">
                                            <div class="thumb">
                                                <ul>
                                                    <li><img src="{{ asset('images/others/author1.png') }}" alt="Author">
                                                    </li>
                                                    <li><img src="{{ asset('images/others/author2.png') }}" alt="Author">
                                                    </li>
                                                    <li><img src="{{ asset('images/others/author3.png') }}" alt="Author">
                                                    </li>
                                                    <li><img src="{{ asset('images/others/author4.png') }}" alt="Author">
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="content">
                ...
                <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                            <a href="{{ route('categories.index') }}" class="your-navbar-link-class">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-4.png') }}"
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-5.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-11.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-6.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="600" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-2.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-7.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="800" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-8.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-1.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-9.png') }}"
                                    alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="{{ asset('images/product/categories/elec-10.png') }}"
                                    alt="product categorie">
        ...
        <div class="axil-product-area bg-color-white axil-section-gap">
            <div class="container">
                <div class="section-title-wrapper">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-3 mt-lg-0 mb-3">
                        <form method="GET" action="{{ route('home') }}">
                            <select name="sort_by" onchange="this.form.submit()">
                                ...
                                <option value="price" {{ request('sort_by') === 'price' ? 'selected' : '' }}>Giá tăng dần
                                </option>
                            </select>
                        </form>
                                        ...
                                        <div class="thumbnail">
                                            <a href="{{ route('product.detail', ['id' => $product->id]) }}">
                                                <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800"
                                                    ...
                                                    src="{{ asset('images/product/electric/' . $product->product_image) }}"
                                                    alt="Product Images">
                                                <img class="hover-img"
                                                    src="{{ asset('images/product/electric/' . $product->product_image) }}"
                                                    alt="Product Images">
                                            ...
                                            <div class="label-block label-right">
                                                @if ($product->discount_rate) {{-- Kiểm tra discount_rate có tồn tại và khác 0
                                                    không --}}
                                        ...
                                        <div class="product-content">
                                            <div class="inner">
                                                ...
                                                <div class="product-price-variant">
                                                    {{-- Sửa ở đây: Sử dụng optional() để an toàn truy cập thuộc tính và đảm bảo
                                                    product_items không rỗng --}}
                                                    @php
                                                        $firstProductItemPrice = optional($product->product_items->first())->price;
                                                        $currentPrice = null;
                                                        $oldPrice = null;

                                                        if ($firstProductItemPrice !== null) {
                                                            $currentPrice = $firstProductItemPrice;
                                                            if ($product->discount_rate) {
                                                                $currentPrice = $firstProductItemPrice * (1 - $product->discount_rate);
                                                                $oldPrice = $firstProductItemPrice;
                                                            }
                                                        }
                                                    @endphp
                                                    ...
                                                    @if ($currentPrice !== null)
                                                        <span
                                                            class="price current-price">{{ number_format($currentPrice, 0, ",", ".")}}đ</span>
                                                    @else
                                                        {{-- Tùy chọn: Hiển thị thông báo nếu không có giá --}}
                                                        <span class="price current-price">Giá liên hệ</span>
                                                    @endif

                                                    @if ($oldPrice !== null) {{-- Chỉ hiển thị giá cũ nếu có chiết khấu và giá
                                                        cũ tồn tại --}}
                                                        <span
                                                            class="price old-price">{{ number_format($oldPrice, 0, ",", ".") }}đ</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-02.png') }}"
                                                alt="Product Images">
                                            <img class="hover-img"
                                                src="{{ asset('images/product/electric/product-06.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                    ...
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-03.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                    ...
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-04.png') }}"
                                                alt="Product Images">
                                            <img class="hover-img"
                                                src="{{ asset('images/product/electric/product-05.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                            ...
                            {{-- <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-05.png') }}"
                                                alt="Product Images">
                                            <img class="hover-img"
                                                src="{{ asset('images/product/electric/product-04.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            {{-- <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-06.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            {{-- <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-07.png') }}"
                                                alt="Product Images">
                                            <img class="hover-img"
                                                src="{{ asset('images/product/electric/product-08.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            {{-- <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800"
                                                loading="lazy" src="{{ asset('images/product/electric/product-08.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                        ...
                        <div class="row row--15">
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-01.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-02.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-03.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-04.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-05.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-06.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-07.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="{{ asset('images/product/electric/product-08.png') }}"
                                                alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
            ...
            <div class="container">
                <div class="section-title-wrapper">
                    <span class="title-highlighter highlighter-primary"><i class="far fa-shopping-basket"></i>This
                        Month</span>
                    <h2 class="title">Các sản phấm bán chạy</h2>
                </div>
                <div class="new-arrivals-product-activation slick-layout-wrapper--30 axil-slick-arrow arrow-top-slide">
                    {{-- Dòng này có thể là một placeholder cho một sản phẩm duy nhất hoặc một item mẫu --}}
                    {{-- <div class="axil-product product-style-two">
                        <div class="thumbnail">
                            <a href="single-product.html">
                                <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500"
                                    src="assets/images/product/product-01.png" alt="Product Images">
                            </a>
                            ...
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    ...
                                    <li class="quickview"><a href="#" data-bs-toggle="modal"
                                            data-bs-target="#quickview-modal"><i class="far fa-eye"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href="single-product.html">3D Cable</a></h5>
                                <div class="product-price-variant">
                                    <span class="price current-price">$30.00</span>
                    ...
                    {{-- Hết phần placeholder --}}

                    @forelse ($newArrivalProductItems as $productItem) {{-- Correct: Using $newArrivalProductItems as
                        $productItem --}}
                        <div class="axil-product product-style-two">
                            <div class="thumbnail">
                                {{-- Đảm bảo route 'product.detail' trỏ đến ProductItemController@detail và nhận ID của
                                ProductItem --}}
                                {{-- Sử dụng $productItem->id để tạo URL chi tiết sản phẩm --}}
                                <a href="{{ route('product.detail', $productItem->id) }}">
                                    {{-- Lấy đường dẫn ảnh từ product_image của ProductItem --}}
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500"
                                        src="{{ asset('storage/' . $productItem->product_image) }}" {{-- Correct:
                                        $productItem->product_image --}}
                                    alt="{{ $productItem->product->name ?? 'Sản phẩm' }}"> {{-- Correct:
                                    ...
                                    <ul class="cart-action">
                                        ...
                                        <li class="select-option">
                                            <form action="{{ route('cart.store') }}" method="POST">
                                                @csrf
                                                {{-- Sử dụng $productItem->id cho product_item_id --}}
                                                <input type="hidden" name="product_item_id" value="{{ $productItem->id }}"> {{--
                                                Correct: $productItem->id --}}
                                                <input type="hidden" name="quantity" value="1">
                                                <button type="submit" class="no-style-button">Add to Cart</button>
                                            </form>
                                        </li>
                                        <li class="quickview"><a href="#" data-bs-toggle="modal"
                                                data-bs-target="#quickview-modal"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    {{-- Lấy tên sản phẩm từ Product cha thông qua $productItem->product->name --}}
                                    <h5 class="title"><a
                                            href="{{ route('product.detail', $productItem->id) }}">{{ $productItem->product->name ?? 'Tên sản phẩm' }}</a>
                                    </h5> {{-- Correct: $productItem->product->name --}}
                                    <div class="product-price-variant">
                                        {{-- Lấy giá từ ProductItem --}}
                                        <span class="price current-price">${{ number_format($productItem->price, 2) }}</span>
                                        {{-- Correct: $productItem->price --}}
                                        {{-- Nếu có giá cũ, bạn có thể hiển thị: --}}
                                        {{-- <span class="price old-price">${{ number_format($productItem->old_price, 2)
                                            }}</span> --}}
                                    </div>
                                    <div class="product-rating">
                                        <span class="icon">
                                        ...
                                        {{-- <span class="rating-number">({{ $productItem->reviews_count ?? 0 }})</span> --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                    @empty
                        <p class="col-12 text-center py-5">Chưa có sản phẩm mới nào.</p>
                    @endforelse
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500"
                                            src="{{ asset('images/product/electric/product-07.png') }}"
                                            alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="100" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-09.png') }}"
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="200" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-10.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="300" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-11.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-12.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-13.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                ...
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="600" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-14.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-15.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500"
                                            src="{{ asset('images/product/electric/product-16.png') }}"
                                            alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
