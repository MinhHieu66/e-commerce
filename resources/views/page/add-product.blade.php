                                ...
                                <div class="card-body">
                                    <div class="digital-add needs-validation">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="validationCustomtitle" name="SKU" type="text">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="validationCustom02" class="col-form-label"><span>*</span>
                                                Giá sản phẩm</label>
                                            <input class="form-control" id="validationCustom02" name="price" type="text">
                                        </div>
                                    ...
                                    <div class="digital-add needs-validation">
                                        <div class="form-group mb-0">
                                            <div class="description-sm">
                                                <textarea id="editor1" name="editor1" cols="10" rows="4" style="display: none;"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="digital-add needs-validation">
                                        <div class="form-group">
                                            <label for="validationCustom05" class="col-form-label pt-0">
                                                Số lượng</label>
                                            <input class="form-control" id="validationCustom05" name="qty-in-stock" type="text">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label categories-basic"><span>*</span>
                                                Dung lượng</label>
