                                    ...
                                    <div class="digital-add needs-validation">
                                        <div class="form-group">
                                            <label for="validationCustom01" class="col-form-label pt-0"><span>*</span>
                                                Tên sản phẩm</label>
                                            <input class="form-control" id="validationCustom01" value="{{ old('name', $product_item->product->name) }}" name="name" type="text">
                                             @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="validationCustomtitle" value="{{ old('SKU', $product_item->SKU) }}" name="SKU" type="text">
                                            @error('SKU')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="validationCustom02" class="col-form-label"><span>*</span>
                                                Giá sản phẩm</label>
                                            <input class="form-control" id="validationCustom02" value="{{ old('price', $product_item->price) }}" name="price" type="text">
                                             @error('price')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <img id="previewImage" width="75%" src="{{ asset('images/product/electric/' . $product_item->product->product_image) }}">
                                        </div>
                                    ...
                                    <div class="digital-add needs-validation">
                                        <div class="form-group mb-0">
                                            <div class="description-sm">
                                                <textarea id="editor1" name="description" cols="10" rows="4" style="display: none;"> {{ old('description', $product_item->product->description) }}</textarea>
                                                @error('description')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="digital-add needs-validation">
                                        <div class="form-group">
                                            <label for="validationCustom05" class="col-form-label pt-0">
                                                Số lượng</label>
                                            <input class="form-control" id="validationCustom05" value="{{ old('qty-in-stock', $product_item->qty_in_stock) }}" name="qty-in-stock" type="text">
                                            @error('qty-in-stock')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
