...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/product-listdigital.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Apr 2025 07:05:34 GMT -->
<head>
            ...
            <div class="page-sidebar">
                <div class="main-header-left d-none d-lg-block">
                    <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded"
                                src="{{ asset('assets/images/dashboard/multikart-logo.png') }}" alt=""></a></div>
                </div>
                                        ...
                                        <table class="table list-digital all-package table-category "
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/web-dev.jpg"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/3d-design.jpg"
                                                            data-field="image" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/graphic-design.png"
                                                            data-field="image" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/logo.jpg"
                                                            data-field="image" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/php.png" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/html.png" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/css.jpg" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/wordpress.jpg" alt="">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('assets/images/digital-product/3d-design.jpg" alt="">
                                                    </td>
