                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="page-header-left">
                                    <h3>Thêm chương trình khuyến mãi
                            ...
                            <div class="col-lg-6">
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="breadcrumb-item active">Thêm chương trình khuyến mãi</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    <label for="name" class="col-xl-3 col-md-4"><span>*</span> Tên chương trình</label>
                                                    <div class="col-md-7">
                                                ...
                                                {{-- Ngày bắt đầu --}}
                                                <div class="form-group row">
                                                    <label for="start_date" class="col-xl-3 col-md-4"><span>*</span> Ngày bắt đầu</label>
                                                    <div class="col-md-7">
                                                ...
                                                {{-- Ngày kết thúc --}}
                                                <div class="form-group row">
                                                    <label for="end_date" class="col-xl-3 col-md-4">Ngày kết thúc</label>
                                                    <div class="col-md-7">
                                                ...
                                                {{-- Tỷ lệ chiết khấu --}}
                                                <div class="form-group row">
                                                    <label for="discount_rate" class="col-xl-3 col-md-4"><span>*</span> Tỷ lệ</label>
                                                    <div class="col-md-7">
